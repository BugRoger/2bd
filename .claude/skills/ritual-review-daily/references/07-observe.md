...
Learn from the session to improve future review rituals. Observations flow freely into Synthetic, cluster automatically, graduate when mature, and crystallize into template insights.
...
Append to `00_Brain/Synthetic/review-daily/observations.md` ## Observations with type `user-modification` or `skill-generated`:
- `user-modification`: Changes user made during review session
- `skill-generated`: How review coaching produced content differently than template examples
...
Append to `00_Brain/Synthetic/review-daily/observations.md` ## Observations with type `session-interaction`:
...
1. Read `00_Brain/Synthetic/review-daily/observations.md` ## Observations
...
5. System records cluster state in `00_Brain/Synthetic/review-daily/observations.md` ## Clusters:
...
3. Removes cluster from `00_Brain/Synthetic/review-daily/observations.md` ## Clusters (prune)
4. Removes member observations from `00_Brain/Synthetic/review-daily/observations.md` ## Observations (prune)
...
2. User answers: **"What does this pattern mean for your review process?"**
   - Write 1-2 sentence synthesis of the insight
   - Note any coaching or template changes this suggests
   - Note uncertainty if needed

3. System writes to `00_Brain/Semantic/review-daily/insights.md` with structure:
...
1. Read `00_Brain/Semantic/review-daily/insights.md`
...
- Review ritual learns how to better serve this specific user over time
