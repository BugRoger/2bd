...
3. [Priority Status](references/02-priority-status.md)
4. [Coached Wins](references/03-coached-wins.md)
...
Today.md sections updated during review:

| Phase | Updates |
|-------|---------|
| Priority Status | `## Daily Brief` > Priorities (completion status) |
| Coached Wins | `## Journal` > Wins |
| Coached Insights | `## Journal` > Insights |
