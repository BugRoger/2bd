...
Synthesize learnings from the prior quarter to inform this one. This is retrospective intelligence — patterns, accomplishments, and carryover candidates that shape the quarter ahead.

Skip this phase for Q1 planning when no prior quarter exists.
...
- **Organisational** — Team/process improvements shipped
- **Strategic** — Deliverables completed, milestones hit

**Metrics:**
- Outcome completion rate (planned vs achieved)
- Major deliverables shipped
- Notable wins worth celebrating
...
For each candidate: assess honest effort vs deferral vs abandonment
...
- **Key relationships** — People invested in, connections deepened

### Active Projects

From project files, present quarterly timeline view:
- All active projects
- Flag overdue (deadlines passed)
- Flag due-soon (deadlines this quarter)
- Next milestone for each
- Note multi-quarter projects

## Update Quarter.md

After presenting prior synthesis:
