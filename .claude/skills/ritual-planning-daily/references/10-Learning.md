...
For each track phase (Brief, Goals, Calendar, Journal, Achievements, Relationships, Projects):
...
Compare final Today.md against template.
...
- If clear and minor → suggest update to `00_Brain/Systemic/Coaching/{Track}/daily.md`
- If major → flag for discussion

### Template Updates

Review `00_Brain/Semantic/Coaching/Template/insights.md` for template changes:
- If H3 addition or content pattern → apply to `00_Brain/Systemic/Templates/Captive/Today.md`
