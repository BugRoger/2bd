...
Set the leadership intention based on week type and user context.

You've set the priorities. Now anchor them with a leadership intention — how the user will show up this week.

## Week Type Intentions
...
1. Present relevant intentions for the week type
2. Connect to growth edge from check-in conversation
3. Let the user choose or suggest their own
4. Confirm the selection

One intention. Not multiple. What's the leadership stance for this week?
...
After selection, summarize the week:
...
After setting intention:

1. Read `00_Brain/Captive/Week.md`
2. Replace `## Leadership Intention` section with:
   - The selected intention
   - Connection to growth edge
   - How to demonstrate it this week
3. Update frontmatter:
   - `leadership_intention`: selected intention
