...
Compare final Week.md against template.
...
- If clear and minor → suggest update to `00_Brain/Systemic/Coaching/{Track}/weekly.md`
- If major → flag for discussion

### Template Updates

Review `00_Brain/Semantic/Coaching/Template/insights.md` for template changes:
- If H3 addition or content pattern → apply to `00_Brain/Systemic/Templates/Captive/Week.md`
