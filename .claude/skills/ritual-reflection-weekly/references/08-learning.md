...
Learn from the session to improve future weekly reflection rituals. Observations flow into Synthetic, cluster automatically, graduate when mature, and crystallize into template insights.
...
Append to `00_Brain/Synthetic/reflection-weekly.md` ## Observations with type `user-modification` or `skill-generated`:
...
- People reflection depth (perfunctory vs detailed)
- Forward synthesis focus (tactical vs strategic)
- Semantic update acceptance rate

### Record Observations

Append to `00_Brain/Synthetic/reflection-weekly.md` ## Observations with type `session-interaction`:
...
Example: `- 2026-02-20 | session-interaction | People Reflection | Spent most time on direct reports, skipped peers | Relationship focus on team`
...
1. Read `00_Brain/Synthetic/reflection-weekly.md` ## Observations
...
5. System records cluster state in `00_Brain/Synthetic/reflection-weekly.md` ## Clusters:
...
3. Removes cluster from `00_Brain/Synthetic/reflection-weekly.md` ## Clusters (prune)
4. Removes member observations from `00_Brain/Synthetic/reflection-weekly.md` ## Observations (prune)
...
2. User answers: **"What does this pattern mean for your weekly reflections?"**
...
3. System writes to `00_Brain/Semantic/reflection-weekly.md` with structure:
...
1. Read `00_Brain/Semantic/reflection-weekly.md`
