...
Agent(
  ...
  prompt: "Run @_assistant-goals reflect quarterly in draft mode. Compare plan vs actual, generate draft with findings and placeholders to Synthetic/Assistants/goals/quarterly-reflect-draft.md"
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-calendar reflect quarterly in draft mode. Compare plan vs actual, generate draft with findings and placeholders to Synthetic/Assistants/calendar/quarterly-reflect-draft.md"
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-journal reflect quarterly in draft mode. Generate draft with reflection and placeholders to Synthetic/Assistants/journal/quarterly-reflect-draft.md"
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-achievements reflect quarterly in draft mode. Generate draft with findings and placeholders to Synthetic/Assistants/achievements/quarterly-reflect-draft.md"
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-relationships reflect quarterly in draft mode. Generate draft with findings and placeholders to Synthetic/Assistants/relationships/quarterly-reflect-draft.md"
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-projects reflect quarterly in draft mode. Generate draft with findings and placeholders to Synthetic/Assistants/projects/quarterly-reflect-draft.md"
)
```
...
1. **Reflection questions first** (journal: how was your quarter, pivots)
2. **Achievement questions** (goals: Quests progress, achievements: quarterly wins)
3. **Analysis questions** (calendar: quarter effectiveness, projects: milestones)
...
Use @ada/references/compose/compose action=reflect timescale=quarterly to assemble final note.
...
Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-goals learn quarterly. Analyze patterns and update memory."
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-calendar learn quarterly. Analyze patterns and update memory."
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-journal learn quarterly. Analyze patterns and update memory."
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-achievements learn quarterly. Analyze patterns and update memory."
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-relationships learn quarterly. Analyze patterns and update memory."
)

Agent(
  subagent_type: "general-purpose",
  run_in_background: true,
  prompt: "Run @_assistant-projects learn quarterly. Analyze patterns and update memory."
)
```
