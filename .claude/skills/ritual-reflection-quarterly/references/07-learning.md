...
- **Synthetic**: `$VAULT/00_Brain/Synthetic/reflection-quarterly.md` - active observations being collected
- **Semantic**: `$VAULT/00_Brain/Semantic/reflection-quarterly.md` - crystallized insights that have graduated
...
- Check Synthetic/reflection-quarterly.md for existing clusters
...
3. Move insight to Semantic/reflection-quarterly.md
...
Append session observations to Synthetic/reflection-quarterly.md:
