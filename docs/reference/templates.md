---
title: "Templates"
description: "How templates work and complete reference for Captive templates."
---

Templates define the structure of your working notes. [Rituals](/reference/creating-custom-rituals) use templates to create Captive notes and declare which sections they update through template contracts.
...
- [Goals](/assistants/goals) - The GPS methodology behind these templates
- [How Ada Works](/ada/how-ada-works) - The ritual cycle explained
